...
private:
  ...
  //const char* SType = "Plain Serial Killer";
  const char* Type;
            ...
            case 1: {
                ...
                while (p) {
                    ...
                    switch (p) {
                        ...
                        case 2: {
                            auto *aux = new MissionOriented(0);
                            std::cin >> *aux;
                            W.addWanted(aux);
                            aux->SetReads(false);
                            break;
