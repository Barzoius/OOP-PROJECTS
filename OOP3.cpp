...
//    std::cin>>H;
//
//    Hybrid W("TROY", 9, 197, false, true, true, false, true, false, true);
//    std::cout<<std::endl;
////    std::cin>>W;
//    std::cout<<std::endl;
//    std::cout<<W;
//
//    Hybrid G("DAN", 12, 230, false, true, false, false, true, false, true);
//    std::cout<<std::endl;
////    std::cin>>G;
//    std::cout<<std::endl;
//    std::cout<<G;
...
//    ThrillSeeker D("KORI", 16, 176, true);
//
//
////    std::cin>>D;
//    std::cout<<std::endl;
...
//    Hybrid H("DAN", 12, 230, false, true, false, false, true, false, true);
//    std::cout<<std::endl;
//    std::cout<<std::endl;
//    std::cout<<std::endl;
//    std::cout<<H;

//    SerialKiller S("Ted", 1, 10);
////    std::cin>>S;
//    std::cout<<S;
//    std::cout<<std::endl;
//    SerialKiller J("POP", 41, 100);
//    MissionOriented M("MARIUS", 5, 153, false, false, false);
////    std::cin>>J;
//    std::cout<<J;
//    std::cout<<std::endl;
...
//    Hybrid H("DAN", 12, 230, false, true, true, false, true, false, true);
//    Hybrid W("TROY", 9, 197, false, true, true, false, true, false, true);
//    std::cout<<std::endl;
//    Hybrid G(H);
//    std::cout<<std::endl;
